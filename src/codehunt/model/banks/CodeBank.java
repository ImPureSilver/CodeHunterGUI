...
//    }
    ...
    public List<String> pullCodes() {

        List<String> copyOfFoundCodes = new ArrayList<>();

        for (String code : this.foundCodes) {
            copyOfFoundCodes.add(code);
        }

        return copyOfFoundCodes;
    }

    public int totalCodes() {
        return this.foundCodes.size();
    }
